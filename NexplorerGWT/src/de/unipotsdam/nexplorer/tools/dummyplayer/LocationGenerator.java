...
public class LocationGenerator {
	...
	public Location generateStartLocation(int direction) {
	...
	public Location getLastLocation() {
		return new Location(lastLatitude, lastLongitude);
	}
	...
	public Location generateNextLocation(double distance, double direction) {
