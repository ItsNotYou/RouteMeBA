<?php
	...
	$secondDataPacket = new AODVDataPacket;
	$secondDataPacket->currentNodeId = $secondNode->id;
	$secondDataPacket->sourceId = $firstNode->id;
	$secondDataPacket->destinationId = $thirdNode->id;
	$secondDataPacket->hopsDone = 1;
	$secondDataPacket->status = AODV_DATA_PACKET_STATUS_UNDERWAY;
	$secondDataPacket->processingRound = 1;
	$secondDataPacket->save();
	...
	if ($secondDataPacket->status == AODV_DATA_PACKET_STATUS_NODE_BUSY) {
