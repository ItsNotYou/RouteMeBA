<?php
	...
	$_POST['ownerId'] = $firstNode->id;
	$_POST['sourceNodeId'] = $firstNode->id;
	$_POST['destinationNodeId'] = $thirdNode->id;
	...
	if ($newMessage->status == AODV_DATA_PACKET_STATUS_WAITING_FOR_ROUTE) {
