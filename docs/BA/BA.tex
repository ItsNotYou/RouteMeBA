...
\begin{figure}
	\centering
	\parbox{7.5cm}{
		\includegraphics[width=7.5cm]{pics/connected-nodes.png}%
		\caption{Einführungs-Folien (Ausschnitt)}%
		\label{fig:routeme-einfuehrung}%
	}%
	\qquad
	\begin{minipage}{7.5cm}%	
		\includegraphics[width=7.5cm]{pics/disconnected-nodes.png}%
		\caption{Indoor-Sicht (Ausschnitt)}%
		\label{fig:routeme-spielknoten}%	
	\end{minipage}%
\end{figure}
