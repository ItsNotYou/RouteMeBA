...
Das Spiel wurde bereits in einer Veröffentlichung vorgestellt.~\cite{Zender.2012}
...
\begin{itemize}
	...
	\item Spiel im Rahmen einer Diplomarbeit erstellt~\cite{Moebert.2011A}
	\item Später technisch Weiterentwickelt~\cite{Dehne.26.April2013}
\end{itemize}
