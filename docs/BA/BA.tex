...
Wie die Android-App bereits zeigt, ist eine native App den getesteten Browser bei den Zugriffen auf Smartphone-Sensoren überlegen. Für das Spiel wird eine Genauigkeit benötigt, die das Browser-basierte Spiel von selbst nicht liefern kann.
...
\subsubsection{Lagesensor}

\subsubsection{Drehende Karte}
