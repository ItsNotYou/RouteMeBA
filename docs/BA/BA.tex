...
Geolocation-Daten können aus unterschiedlichen Quellen stammen. Eine Übersicht von Quellen stellt Abbildung~\ref{fig:gps_sources} dar. Die häufigsten Geolocation-Quellen auf den getesteten Smartphones waren WLAN- und GPS-Daten, wobei WLAN eine Genauigkeit von 20 bis 50m und GPS eine Genauigkeit von 5 bis 15m im vorgesehenen Spielbereich hatte.
...
\begin{itemize}
	...
	\item Verwendet HTTP-Verben PUT, POST, GET und DELETE, um dokumentbasierte Kommunikation zwischen Client und Server zu ermöglichen
...
\begin{itemize}
	\item Jedes Routing-Protokoll hat 
\end{itemize}
